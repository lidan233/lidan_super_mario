...
void Textures::drawMario(int x, int y){
    ...
    glEnd();
    marioy_current = y+128+64 ;
    marioy1_current = y+128;
}
...
bool Textures:: collasp(int miny,int maxy)
{
    if(marioy_current>=miny&&marioy_current<=maxy)
    {
        return true;
    }
    return false ;
...
bool Textures:: collasp1(int miny,int maxy)
{
    if(marioy1_current>=miny&&marioy1_current<=maxy)
    {
        return true;
    }
    return false ;
